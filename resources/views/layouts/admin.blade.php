...
<div class="navbar navbar-default" role="navigation">
    ...
    <div class="navbar-inner">
        ...
        <a class="navbar-brand" href="index.html"> <img alt="Charisma Logo" src="{{$adminurl}}/img/logo20.png" class="hidden-xs"/>
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="{{url('admin/cate')}}"><i class="glyphicon glyphicon-list-alt"></i><span> 文章分类</span></a>
                        </li>
